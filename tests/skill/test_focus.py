...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("why", "The developer's poor judgment caused rework"),
        ("guidance", "The developer lacks diligence"),
        ("title", "Engineer Is Unprofessional"),
        ("trigger", "when the programmer showed questionable judgment"),
        ("guidance", "The employee has no professional integrity"),
        ("why", "Their lack of discipline required another review"),
        ("trigger", "when the coder is not sufficiently diligent"),
        ("why", "The developer exercised questionable judgment"),
        ("why", "Poor judgment by the developer delayed the handoff"),
        ("why", "The developer lacks diligence on tests"),
        ("why", "The developer has poor judgment in code review"),
        ("guidance", "The developer has strong test coverage and poor judgment"),
        ("trigger", "when the developer is blocked by CI and unprofessional"),
        ("why", "The developer is in a pattern of poor judgment"),
        ("guidance", "The developer can be unprofessional"),
        ("why", "The engineer behaves unprofessionally"),
        ("why", "The developer acted unprofessionally"),
        ("guidance", "The coder makes reckless decisions"),
        ("trigger", "when the developer is fixing tests carelessly"),
        ("guidance", "avoid the developer's shortsighted decisions"),
        ("title", "Shortsighted Developer"),
        ("guidance", "The developer should not be unprofessional"),
        ("why", "We lack discipline"),
        ("why", "The developer needs better judgment"),
        ("guidance", "The developer ought to be more diligent"),
        ("trigger", "when the developer tends to be unprofessional"),
        ("why", "The developer has sound code-review judgment"),
        ("guidance", "They are unprofessional"),
        ("guidance", "They lack diligence"),
        ("why", "He has poor judgment"),
        ("guidance", "The developer made bad decisions"),
        ("guidance", "Avoid the developer's poor decisions"),
        ("trigger", "when the developer is fixing tests with poor decision-making"),
        ("why", "The developer performs poorly"),
        ("why", "The developer did a terrible job"),
        ("why", "The developer is poor at code review"),
        ("why", "The developer is bad with tests"),
        ("why", "The developer is terrible at code review"),
        ("why", "The developer delivered poor work"),
        ("why", "The developer evaluates reviewer competence"),
        ("why", "The developer questions reviewer competence"),
        ("why", "The developer questions the reviewer's competence"),
        ("why", "The developer has poor ownership of the issue"),
        ("why", "The engineer is inept at code review"),
        ("why", "The developer is mediocre with tests"),
        ("why", "The developer is being inept at code review"),
        ("why", "The developer is acting unprofessionally during review"),
        ("why", "The developer is underperforming on tests"),
        ("why", "The developer is procrastinating on validation"),
        ("why", "The developer is performing poorly in code review"),
        ("why", "The developer is looking careless during review"),
        ("why", "The developer behaves stupidly"),
        ("why", "The developer is working lazily"),
        ("why", "The developer is fixing tests stupidly"),
        ("why", "The developer fixes tests stupidly"),
        ("why", "The developer keeps making foolish choices"),
        ("why", "The developer is making careless decisions"),
        ("why", "The developer repeatedly makes unsound decisions"),
        ("why", "The developer chooses badly"),
        ("title", "Unprofessional Developer"),
        ("title", "Developer Unprofessionalism"),
        ("title", "Poor Judgment"),
        ("title", "Lack of Diligence"),
    ],
)
def test_personal_evaluation_morphology_does_not_bypass_safeguard(field, text):
    corpus = _corpus([
        _candidate("s1", "alpha", 27),
        _candidate("s2", "alpha", 28),
        _candidate("s3", "beta", 28),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("trigger", "when the coding agent is blocked by CI"),
        ("trigger", "when the developer is responsible for deployment"),
        ("trigger", "when the user is unauthenticated"),
        ("guidance", "the developer lacks database access"),
        ("guidance", "the author has insufficient permissions"),
        ("guidance", "the engineer showed weak test coverage"),
        ("guidance", "the developer made a poor implementation choice"),
        ("why", "The developer's poor test fixture caused the failure"),
        ("title", "Improve Reliability"),
        ("trigger", "when the developer is asked to review a patch"),
        ("trigger", "when you are making changes to a schema"),
        ("trigger", "when the developer is unable to access the database"),
        ("trigger", "when the user is missing permissions"),
        ("trigger", "when the agent is uncertain which command to run"),
        ("trigger", "when the reviewer is requesting changes"),
        ("trigger", "when the user is trying to authenticate"),
        ("title", "Inspect"),
        ("title", "Implement"),
        ("title", "Improve"),
        ("title", "Strong Finish"),
        ("trigger", "when the developer is on the main branch"),
        ("trigger", "when the agent is in code review"),
        ("guidance", "the developer fixes tests that perform poorly"),
        ("guidance", "the developer runs tests because CI behaves poorly"),
        ("trigger", "when the user is logged in"),
        ("guidance", "the developer fixed a service that behaved unreliably"),
        ("trigger", "when the developer is fixing tests, then rerunning validation"),
        ("guidance", "the developer verifies data integrity before migration"),
        ("guidance", "the agent checks API capabilities before use"),
        ("guidance", "the developer documents component responsibility"),
        ("title", "Preserve Data Integrity"),
        ("title", "Map Component Responsibility"),
        ("title", "Model Capability Check"),
        ("guidance", "the developer fixes badly formatted code"),
        ("guidance", "the developer waits while the service behaves badly"),
        ("guidance", "the developer reviews bad decisions made by the model"),
        ("guidance", "the developer records the reviewer judgment in the report"),
        ("guidance", "the report records the judgment by the reviewer"),
        ("guidance", "a poor test by the developer caused the CI failure"),
        ("guidance", "a weak implementation by the developer failed validation"),
        ("guidance", "a questionable patch by the developer required rework"),
        ("guidance", "the developer documents component ownership"),
        ("guidance", "the developer is fixing code and tests"),
        ("guidance", "the developer is reviewing API responses and test results"),
        ("guidance", "the developer is fixing code and integration tests"),
        ("guidance", "the developer is fixing code and flaky tests"),
        ("guidance", "the developer is fixing code and failing tests"),
        ("guidance", "the developer is fixing code and tests in CI"),
        ("guidance", "the developer is fixing code and unit tests"),
        ("guidance", "the developer is reviewing API responses and failing test results"),
        ("guidance", "the developer is refactoring code"),
        ("guidance", "the developer is resolving merge conflicts"),
        ("guidance", "the developer is the code owner"),
        ("guidance", "the developer is a project maintainer"),
        ("guidance", "the user is the account owner"),
        ("guidance", "the agent is a test service"),
        ("guidance", "the agent is planning a database migration"),
        ("guidance", "you are profiling a slow service"),
        ("guidance", "the agent is measuring test coverage"),
        ("guidance", "the agent is performing tests"),
        ("guidance", "the agent is triaging deployment issues"),
        ("guidance", "the developer is migrating a production database"),
        ("guidance", "the developer is bootstrapping a fresh database"),
        ("guidance", "the developer is traversing a dependency graph"),
        ("guidance", "when integration tests fail, they are flaky until quarantined"),
        ("trigger", "when the developer has enough time to run the suite"),
        ("trigger", "when you have explicit user approval"),
        ("trigger", "when the developer has approval to proceed"),
        ("trigger", "when you have confirmation from the user"),
        ("trigger", "when the developer has consent to publish"),
        ("trigger", "when you are awaiting user approval"),
    ],
)
