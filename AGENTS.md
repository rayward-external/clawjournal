...
- **Recurring sharing is a separate authorization.** It is default-off, future-only, capped at five, exact-scope, and unavailable without hosted protocol-v1 discovery plus a successful manual receipt. Manual Share behavior must not change.
